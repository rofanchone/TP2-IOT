...
class Modbus {
    private:
        ...
        void (*m_onRegisterWritten)(word regOffset) = NULL;
        void (*m_onRegisterReaded)(word startreg, word numregs) = NULL;
    ...
    public:
        ...
        void addOnRegisterWrittenEvent(void (*onRegisterWritten)(word regOffset));
        void addOnRegisterReadedEvent(void (*onRegisterReaded)(word startreg, word numregs));
};
