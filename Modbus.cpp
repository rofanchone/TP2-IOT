...
void Modbus::readRegisters(word startreg, word numregs) {
    ...
    if(m_onRegisterReaded != NULL)
      m_onRegisterReaded(startreg, numregs);
}
...
void Modbus::writeSingleRegister(word reg, word value) {
    ...
    if(m_onRegisterWritten != NULL)
      m_onRegisterWritten(reg);
...
void Modbus::writeMultipleRegisters(byte* frame,word startreg, word numoutputs, byte bytecount) {
    ...
    if(m_onRegisterWritten != NULL)
      m_onRegisterWritten(startreg + i);
...
void Modbus::addOnRegisterWrittenEvent(void (*onRegisterWritten)(word regOffset))
{
  m_onRegisterWritten = onRegisterWritten;
}

void Modbus::addOnRegisterReadedEvent(void (*onRegisterReaded)(word startreg, word numregs))
{
  m_onRegisterReaded = onRegisterReaded;
}
